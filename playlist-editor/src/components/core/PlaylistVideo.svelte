...
>
  ...
  <!-- svelte-ignore a11y-no-static-element-interactions -->
  <div class="video-btns" on:click|stopPropagation on:keydown|stopPropagation role="toolbar" tabindex="0" aria-label="Video actions">
...
<style>
  ...
  .thumb-btn { border: none; background: none; padding: 0; cursor: pointer; }
